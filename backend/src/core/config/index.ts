...
export const config = {
  ...
  ai: {
    ...
    // Free-tier failover: OpenRouter Qwen → Hugging Face Qwen → Groq → OpenAI
    ...
    huggingfaceApiKey: process.env.HUGGINGFACE_API_KEY || process.env.HF_TOKEN || process.env.HF_API_TOKEN || '',
    huggingfaceApiBase: process.env.HUGGINGFACE_API_BASE || 'https://router.huggingface.co/v1',
    huggingfaceModel: process.env.HUGGINGFACE_MODEL || 'Qwen/Qwen2.5-7B-Instruct',
    huggingfaceModels: process.env.HUGGINGFACE_MODELS || '',
    groqApiKey: process.env.GROQ_API_KEY || '',
    groqApiBase: process.env.GROQ_API_BASE || 'https://api.groq.com/openai/v1',
    groqModel: process.env.GROQ_MODEL || 'llama-3.3-70b-versatile',
    groqModels: process.env.GROQ_MODELS || '',
    llmProviderOrder: process.env.LLM_PROVIDER_ORDER || 'openrouter,huggingface,groq,openai',
  },
  social: {
